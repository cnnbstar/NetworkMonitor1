...
def id_netstat_processes():
    ...
    for item in networkitems:
        ...
        if pid in tasks.keys():
            ...
            output += localport.ljust(10).decode('gbk') + remoteip.ljust(20).decode('gbk') + pid.ljust(10).decode('gbk') + imagename.ljust(35).decode('gbk')  + user.ljust(35).decode('gbk') + title.decode('gbk') + "\n"
        else:
            ...
            output += localport.ljust(10).decode('gbk') + remoteip.ljust(20).decode('gbk') + "PID "+ pid.decode('gbk') +" Missing" + "\n"
