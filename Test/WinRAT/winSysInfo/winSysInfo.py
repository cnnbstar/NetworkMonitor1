...
class informations:
	...
	def kj_time(self):
		try:
			...
			f=io.open("./Informations/kj_time.txt",'w',encoding='utf-8')
			f.write(time.decode('gbk'))
			f.close()
	...
	def ip_mac(self):
		try:
			...
			f=io.open("./Informations/ip_mac.txt",'w',encoding='utf-8')
			f.write(ip_mac.decode('gbk'))
			f.close()
	...
	def users(self):
		...
		encode('utf-8'): 从UNICODE编码成UTF-8
		decode('gbk'):从GBK解码成UNICODE
		'''
		try:
			users=os.popen("net user").read()
			f=io.open("./Informations/users.txt",'w',encoding='utf-8')
			f.write(users.decode('gbk'))
			f.close()
	...
	def os_version(self):
		try:
			...
			f=io.open("./Informations/systeminfo.txt",'w',encoding='utf-8')
			f.write(os_version.decode('gbk'))
			f.close()
	...
	def tasklist(self):
		try:
			...
			f=io.open("./Informations/tasklist.txt",'w',encoding='utf-8')
			f.write(tasklist.decode('gbk'))
			f.close()
	...
	def netstat(self):
		try:
			...
			f=io.open("./Informations/netstat.txt",'w',encoding='utf-8')
			f.write(netstat.decode('gbk'))
			f.close()
